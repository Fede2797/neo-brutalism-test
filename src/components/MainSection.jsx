...
export const MainSection = () => {
  return (
    <div className="w-full h-full mb-[100vh] min-h-[300px] grid grid-cols-1 md:grid-cols-2 gap-[2px] bg-black">
      ...
      <div className="mb-[2px] bg-[#23a094] flex justify-center items-center gap-4 md:my-[2px]">
        ...
        >
          ...
          shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] hover:shadow-none duration-200 hover:translate-x-[5px] hover:translate-y-[5px] hover:cursor-pointer">
